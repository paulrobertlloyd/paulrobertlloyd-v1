...
var mtCookieDomain = ".v8.paulrobertlloyd.com";
var mtCookiePath = "/";
...
_setCurrentComments();
  ...
  function _initializeVariables() {
    ...
    loadingIcon = "<img title='Loading...' src='http://v8.paulrobertlloyd.com/_mt-static/images/indicator.white.gif' alt='Loading' />";
...
if (_findIdMatch(found[1])) {
  ...
  function _updateComments() {
    ...
    jsonUrl = [
        "http://v8.paulrobertlloyd.com/cgi-bin/mt/mt-comments.cgi?__mode=comment_listing&direction=",
        direction,
        "&entry_id=",
        entryID,
        "&limit=",
...
function mtFetchUser(cb) {
    ...
    if ( ( cb == 'mtSetUser' ) && mtGetUser() ) {
        ...
        script.src = 'http://v8.paulrobertlloyd.com/cgi-bin/mt/mt-comments.cgi?__mode=session_js&blog_id=1&jsonp=' + cb + '&ts=' + ts;
...
function mtCommentOnSubmit(f) {
    if (!mtRequestSubmitted) {
        ...
        if (f.armor)
            f.armor.value = 'ee515cba0159d7513337b35f0ab977a513bccb39';
...
function mtSignIn() {
    ...
    var url = 'http://v8.paulrobertlloyd.com/cgi-bin/mt/mt-cp.cgi?__mode=login&blog_id=1';
    if (is_preview) {
        if ( document['comments_form'] ) {
            var entry_id = document['comments_form'].entry_id.value;
            url += '&entry_id=' + entry_id;
        } else {
            url += '&return_url=http%3A%2F%2Fv8.paulrobertlloyd.com%2F';
        }
    } else {
...
function mtSignOut(entry_id) {
    ...
    var doc_url = document.URL;
    doc_url = doc_url.replace(/#.+/, '');
    var url = 'http://v8.paulrobertlloyd.com/cgi-bin/mt/mt-cp.cgi?__mode=logout&static=0';
    if (is_preview) {
        if ( document['comments_form'] ) {
            var entry_id = document['comments_form'].entry_id.value;
            url += '&entry_id=' + entry_id;
